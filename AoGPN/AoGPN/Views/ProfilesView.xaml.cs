...
public partial class ProfilesView
{
    ...
    public ProfilesView()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.BindCommand(ViewModel, vm => vm.ScanDeadNodesCmd, v => v.menuScanDeadNodes).DisposeWith(disposables);
            this.BindCommand(ViewModel, vm => vm.ScanDeadNodesCmd, v => v.btnScanDeadNodes).DisposeWith(disposables);
