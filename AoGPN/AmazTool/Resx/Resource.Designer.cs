...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the AoGPN. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start AoGPN, please wait... 的本地化字符串。
        /// </summary>
        internal static string RestartAoGPN {
            get {
                return ResourceManager.GetString("RestartAoGPN", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the AoGPN process... 的本地化字符串。
        /// </summary>
