...
public class Global
{
    public const string AppName = "AoGPN";
    ...
    // arm64/x86 builds; CoreInstaller extracts the amd64 copy.
    public const string WintunDownloadUrl = "https://www.wintun.net/builds/wintun-0.14.1.zip";
    ...
    /// <summary>
    /// Varsayılan WARP egress SOCKS5 portu (sunucuda wireproxy — Almanya düğümünde
    /// 40000). İstemci sing-box bu porta WireGuard tüneli (endpoint) üzerinden bağlanır;
    /// çıkış IP'si Oracle yerine Cloudflare WARP olur (Cloudflare WAF'ın datacenter
    /// IP bloklarını engellemesini aşar).
    /// </summary>
    public const int WarpSocksDefaultPort = 40000;
    ...
    public const string InnerUriProtocol = "aogpn://";
    ...
    public const string AutoRunName = "AoGPNAutoRun";
    ...
    public const string UpdateCoresMode = "--update-cores";
    public const string AvaAssets = "avares://AoGPN/Assets/";
    public const string LocalAppData = "AOGPN_LOCAL_APPLICATION_DATA_V2";
    ...
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/AoGPN/template.json",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/AoGPN/template.json"
    ];

    public static readonly List<string> DNSTemplateSources =
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/AoGPN/",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/AoGPN/"
    ];
    ...
    public const string OpenVPNProtocolShare = "openvpn://";
    ...
    /// <summary>
    /// GPN WireGuard tüneli için önerilen MTU. Canlı ölçüm (Ağu 2026): Tanzanya
    /// → Frankfurt yolunda DF paketleri yalnızca ~1400 bayta kadar geçiyor; 1420
    /// MTU'lu dış paketler (1420+60=1480) sınırı aşıp parçalanıyor. 1360 → dış
    /// paket 1420 ≤ yol sınırı — parçalanma yok. Oyun paketleri küçük olduğundan
    /// performans kaybı yok denecek kadar az.
    /// </summary>
    public const int GpnRecommendedMtu = 1360;
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.openvpn, "OpenVPN/openvpn" },
        { ECoreType.AoGPN, "AhmetOzbay27/AoGPN" },
    };
    ...
    /// <summary>
    /// Processes that are exempt from the QUIC/UDP-443 preemptive block.
    /// These typically carry their own tunnel (WireGuard, OpenVPN) and would
    /// break if the host blocked their UDP control channel. Matched case-
    /// insensitively against <c>GetExeName</c>-normalised process names.
    /// </summary>
    public static readonly IReadOnlyList<string> QuicBlockExemptProcesses =
    [
        "wireguard.exe",
        "wg.exe",
        "openvpn.exe",
