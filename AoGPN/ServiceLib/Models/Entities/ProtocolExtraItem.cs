...
public record ProtocolExtraItem
{
    ...
    /// <summary>WireGuard keepalive saniyesi (0 = kapalı). NAT arkasındaki
    /// istemcilerde tünelin sessizce ölmemesi için gerekli (ör. AoGPN 25 sn).</summary>
    public int? WgPersistentKeepalive { get; init; }
