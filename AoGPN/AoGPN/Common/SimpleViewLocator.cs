...
public class SimpleViewLocator : IViewLocator
{
    ...
    private SimpleViewLocator()
    {
        ...
        Register<ConnectionMonitorViewModel, ConnectionMonitorView>();
        ...
        Register<GpnServerEditViewModel, GpnServerEditWindow>();
        Register<MainWindowViewModel, MainWindow>();
        Register<ManualRouteEditViewModel, ManualRouteEditWindow>();
        ...
        Register<SplitTunnelViewModel, ConnectionView>();
