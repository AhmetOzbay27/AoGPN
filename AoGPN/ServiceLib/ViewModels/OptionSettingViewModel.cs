...
public class OptionSettingViewModel : MyReactiveObject, ICloseable
{
    ...
    [Reactive] public bool Minimize2Tray { get; set; }
    ...
    private async Task Init()
    {
        ...
        Minimize2Tray = _config.UiItem.Minimize2Tray;
    ...
    private async Task SaveSettingAsync()
    {
        ...
        var fontFamilyChanged = CurrentFontFamily != _config.UiItem.CurrentFontFamily;
        ...
        _config.UiItem.Minimize2Tray = Minimize2Tray;
        ...
        {
            // Apply AoGPN's system-proxy settings immediately when exceptions,
            // PAC/script paths, or the advanced protocol change from this dialog.
            // Connection policy may temporarily force proxy capture, but it never
            // replaces the independent saved preference.
            ...
            {
                // Font applies immediately via AppEvents — no restart needed.
